# Batman Forever JAMMA Adapter — Bill of Materials (V1.3)
**Last Updated: 2026-04-13**
**V1.3 change: SW1/SW2/SW4 switched from SS42H11-G9 (AliExpress) to Alps SSSU042100 (Mouser)**
...
| Mouser — Switches | $7.08 |
| Amazon — Voltmeter, IDE cable, SW3 | $4.90 |
| Adafruit — Pot | $2.75 |
| Memotronics — JAMMA connector | $2.69 |
| Wire (estimated per board) | $3.50 |
| **Components subtotal** | **$32.02** |
| Shipping estimate (10%) | $3.20 |
| **Total per board (components + shipping)** | **$35.22** |
| PCB cost (TBD — V1.3 not yet ordered) | TBD |
| **Grand total per assembled unit** | **TBD** |
...
| Mouser — Switches (SW1/SW2/SW4) | $7.08 |
| Amazon — Voltmeter, IDE cable, SW3 | $4.90 |
...
5. **CN2 (JAMMA female connector)** is soldered onto the top edge gold fingers — mechanical part, not a PCB component.
...
10. **Prices verified 2026-04-13.** Per-unit prices calculated from bulk pack costs where applicable.
